    ...
    function patchLocalStorage() {
        ...
        if (typeof originalLoadCurrentDailyData === 'function') {
            window.loadCurrentDailyData = function() {
                ...
                const _currentHasPerBunk = Object.values(window.divisionTimes || {}).some(dt => dt?._isPerBunk);
                if (result?.divisionTimes && !window._divisionTimesLocked && !_currentHasPerBunk && !window._autoGeneratedSchedule) {
