...
function findFirstSlotForTime(startMin) {
    if (startMin === null || !window.unifiedTimes || window.unifiedTimes.length === 0) return -1;
    ...
    // This logic handles the "snap to next" for times like 12:20 (740)
    // 12:00 (720) -> diff 20
    // 12:30 (750) -> diff 10
    // It will correctly choose 12:30.
    
    // This handles 3:20 (920)
    // 3:00 (900) -> diff 20
    // 3:30 (930) -> diff 10
    // It will correctly choose 3:30.
    
    // This handles 3:10 (910)
    // 3:00 (900) -> diff 10
    // 3:30 (930) -> diff 20
    // It will correctly choose 3:00.
