...
(function() {
    ...
    function injectCSP() {
        ...
        const csp = [
            ...
            "connect-src 'self' https://bzqmhcumuarrbueqttfh.supabase.co wss://bzqmhcumuarrbueqttfh.supabase.co https://fonts.googleapis.com https://fonts.gstatic.com https://cdn.jsdelivr.net https://api.open-meteo.com https://api.mapbox.com https://geocoding.geo.census.gov https://api.openrouteservice.org https://nominatim.openstreetmap.org https://graphhopper.com https://router.project-osrm.org https://overpass-api.de https://overpass.kumi.systems https://maps.mail.ru",
            "base-uri 'self'",
            "form-action 'self'"
        ].join('; ');
