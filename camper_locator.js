...
(function() {
    ...
    /**
     * Normalize a matchup entry — handles both string and object formats.
    ...
    /**
     * Legacy fallback — only used if divisionTimes is unavailable.
     */
    ...
    /**
     * Parse a typed time string into minutes since midnight.
    ...
    // =============================================================
    // TEAM HELPERS — ★ v2.0: reads from leaguesByName + specialtyLeagues
    // =============================================================
    function getAllTeams() {
        const settings = window.loadGlobalSettings?.() || {};
        const teams = new Set();

        // Source 1: Regular leagues (leaguesByName) — written by leagues.js
        const regularLeagues = settings.leaguesByName || {};
        ...
        // Source 2: Specialty leagues — written by specialty_leagues.js
        ...
        // Source 3: Legacy fallback (app1.leagueTeams) — old format, no longer written
        if (teams.size === 0) {
    ...
    window.initCamperLocator = function() {
        ...
        console.log("🔍 Camper Locator v2.0 loaded", camperCount, "campers");
        ...
        // 4. Hide suggestions on click away
    ...
    // =============================================================
    // SEARCH LOGIC — Real-Time, Division-Aware
    // =============================================================
    ...
    function performSearch(nameQuery, timeValue) {
        ...
        // Reload roster to catch any updates from other tabs / Campistry Me
        loadRoster();
