...
(function () {
    ...
    var _baseRole = 'manager';  // this Role's account type (migration 275) — admin/manager/scheduler/viewer
    ...
    A.openForGroup = function (group, campId, onSaved) {
        ...
        // (migration 275) — the account type lives HERE, on the Role itself.
    ...
    function bodyHtml() {
        ...
        if (_mode === 'group') {
            ...
            // The account type now lives ON the Role (migration 275) — an
