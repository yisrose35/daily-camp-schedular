...
function setupToolbarEvents() {
  ...
  if (genBtn) genBtn.onclick = function() {
    ...
    // ★ Don't contaminate manual Master Builder with auto-generated skeleton.
    // The auto pipeline passes skeleton directly to the optimizer below.
    // Run optimizer
    if (typeof window.runSkeletonOptimizer === 'function') {
      window.runSkeletonOptimizer(result.skeleton);
      // Clear auto flags so table renderer shows resolved activities
