// -------------------- scheduler_logic.js (Cross-Day Memory + League First + Aggressive Fill + Per-Day Uniqueness) --------------------
// Logic-only: helpers, fixed activities, league helpers/rotation, core scheduling & fillers.
...
function assignFieldsToBunks() {
  ...
  // ===== NEW: per-day uniqueness tracker (global so helpers can read) =====
  ...
  for (const div of availableDivisions) {
    ...
    for (const chosenSlot of candidates) {
      ...
      // ===== NEW: mark league sports as used today for each team
