       ...
       const dateKey = window.currentScheduleDate || window.currentDate || '';
        ...
        if (window.saveCurrentDailyData) {
            try {
               ...
               window.saveCurrentDailyData('scheduleAssignments', clean);
window.saveCurrentDailyData('leagueAssignments', window.leagueAssignments || {});
window.saveCurrentDailyData('manualSkeleton', autoSkeleton);
window.saveCurrentDailyData('_perBunkSlotsData', spbs);
window.saveCurrentDailyData('_autoGenerated', true);
window.saveCurrentDailyData('_autoVersion', VERSION);
window.saveCurrentDailyData('_generatedAt', new Date().toISOString());
window.saveCurrentDailyData('_warnings', warnings);                log('[5] Saved');
