...
(function () {
   ...
   // GAME RESULTS VIEW
    ...
    // ★ Off-paper recorder: lightweight lookup of the leagues a division plays,
    ...
    // ★ Off-paper recorder: record a hand-entered league game (matchup + result)
    //   for a date so it feeds standings exactly like a played+scored game. Tagged
    //   importedFrom:'offpaper' (never touched by the auto-game replace path) and
    //   carries the winner via scoreA/scoreB (1-0 / 0-1 / 1-1). Idempotent per
    //   (date, gameLabel): a re-save replaces the prior off-paper game.
