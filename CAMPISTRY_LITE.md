...
— standalone display, portrait, teal theme.
...
Apply `migrations/015_counselor_role_campistry_lite.sql` in the Supabase SQL
editor. It:
...
| `migrations/015_counselor_role_campistry_lite.sql` | Counselor role + RLS |
