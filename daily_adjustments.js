...
async function runOptimizer() {
 ...
 if (success) {
      // ★★★ AUTO MODE FIX: Clear auto flags so schedule view uses table renderer ★★★
      // The optimizer has filled scheduleAssignments + divisionTimes, so the table
      // renderer (which reads those) should be used — not the raw Gantt timeline.
      window._autoGeneratedSchedule = false;
      window._autoBuildTimelines = null;
