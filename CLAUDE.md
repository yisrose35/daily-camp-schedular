...
| Campistry Lite (mobile companion) | `campistry_lite.html/.js/.css`, `manifest_lite.webmanifest`, `supabase/functions/send-sms/`, `migrations/015_*.sql` — docs in `CAMPISTRY_LITE.md` |
