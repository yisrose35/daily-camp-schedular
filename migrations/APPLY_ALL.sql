-- ═══════════════════════════════════════════════════════════════════════
-- CAMPISTRY — combined migration bundle (run once in the Supabase SQL editor)
-- Includes 024 (multi-camp parent RPCs), 026 (canteen caps), 027 (staff RBAC).
-- Safe to re-run: everything is CREATE OR REPLACE / IF NOT EXISTS / DROP IF EXISTS.
-- ═══════════════════════════════════════════════════════════════════════
