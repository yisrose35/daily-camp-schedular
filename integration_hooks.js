                ...
                window.ScheduleDB.loadSchedule(change.dateKey).then(result => {
                    ...
                    if (result?.success && result.data) {
                        ...
                        try {
                            ...
                            const _LOCAL_ONLY = ['bunkActivityOverrides', 'overrides', 'autoSkeleton', '_autoGenerated', '_autoBuildTimelines', '_autoGenMeta', 'manualSkeleton', 'skeleton', 'dailyDisabledSportsByField', 'dailyFieldAvailability', 'disabledSpecialtyLeagues', 'leagueRoundState', 'leagueDayCounters'];
                            allData[dateKey] = {
