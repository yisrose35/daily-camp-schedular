...
  }
 
  // ### FIX 2: GENERAL ACTIVITY ASSIGNMENT ###
  // Fill general
  for (const div of availableDivisions) {
...
          if (window.leagueAssignments?.[div]?.[currentSlot] ||
...
        td.textContent = "—";
        tr.appendChild(td);
        return; // This return was incorrect, should be continue
      }
 
      // ### FIX 3: LEAGUE RENDERING ###
      if (league) {
        const td = document.createElement("td");
        td.colSpan = bunks.length;
...
          td.style.opacity = "0.7"; // Make it slightly faded
          td.innerHTML = `<div class="league-pill" style="font-size:0.9em;"><em>(cont.)</em></div>`;
        } else {
          // This is the start of the league, render the full info
...
          }
          ...
          // ### FIX 4: GENERAL ACTIVITY RENDERING ###
          if (entry.continuation) {
            td.style.background = "#f9f9f9";
            td.style.color = "#aaa";
            td.innerHTML = "〃"; // Ditto mark for "same as above"
          } 
