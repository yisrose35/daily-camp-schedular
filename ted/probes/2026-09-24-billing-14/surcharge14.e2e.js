...
// Run: node ted/probes/2026-09-24-billing-14/surcharge14.e2e.js
'use strict';
...
${STRIPE}`;
  ...
  try {
    ...
    check('S4b after the second (successful) $1,000 refund, the fee returned is $29.13 in all, as for one refund', Math.abs(owes('slate') - 970.87) < 0.005,
      `fee credits ${feeCredits('slate')}; owes $${owes('slate')} (one refund of $1,000 leaves $970.87)`);
  } catch (e) {
