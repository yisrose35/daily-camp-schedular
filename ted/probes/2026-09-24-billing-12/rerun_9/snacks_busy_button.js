// (12th-pass working copy: supplies the page's top-level _lbl.)
...
const ctx = {
  ...
  // (12th pass) the page's top-level _lbl, which the toast now calls
  _lbl: (k) => String(k == null ? '' : k).replace(/\s#\d+$/, ''),
};
