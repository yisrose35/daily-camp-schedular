// 7th pass copy: loader also cuts _markCardPayment; adds a Cardknox case.
...
test('probe', () => {
    for (const [label, manual] of [
        ...
        ['CARDKNOX deposit, office typed it with reference = the xRefNum', { id: 'pay_ck', familyKey: 'gold', amount: 250, method: 'Card', reference: '123456789', date: '2026-05-02', status: 'succeeded', _proc: 'cardknox' }],
        ...
        vm.runInContext(['_camperIdOf', '_markCardPayment', '_paymentRefOf', '_paymentRefsOf', '_postPaymentEntry', '_postCardDepositsFor'].map(cut).join('\n')
        ...
        const ck = manual._proc === 'cardknox'; delete manual._proc;
        ctx.post(f, 'gold', ck ? { camperName: 'Avi', depositPaid: 250, depositReference: '123456789', depositProcessor: 'cardknox',
            depositCharges: [{ ref: '123456789', amount: 250, date: '2026-05-01', processor: 'cardknox' }] }
          : { camperName: 'Avi', depositPaid: 250, depositReference: 'pi_dep', depositProcessor: 'stripe',
